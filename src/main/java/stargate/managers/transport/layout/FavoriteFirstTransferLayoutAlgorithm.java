 ...
 * @author iychoi
 */
public class FavoriteFirstTransferLayoutAlgorithm extends AbstractTransferLayoutAlgorithm {
    
    public FavoriteFirstTransferLayoutAlgorithm(AbstractService service, TransportManager manager, AbstractBigKeyValueStore dataCacheStore, AbstractContactNodeSelectionAlgorithm contactNodeSelectionAlgorithm) {
        if(service == null) {
    ...
    public FavoriteFirstTransferLayoutAlgorithm(StargateService service, TransportManager manager, AbstractBigKeyValueStore dataCacheStore, AbstractContactNodeSelectionAlgorithm contactNodeSelectionAlgorithm) {
        if(service == null) {
            throw new IllegalArgumentException("service is null");
        }
    ...
    public Node determineRemoteNode(Cluster localCluster, Node localNode, Cluster remoteCluster, Recipe recipe, String hash) throws IOException {
        ...
        if(nodeNames.contains(favoriteNode.getName())) {
            // favorite node has data
            return favoriteNode;
        } else {
