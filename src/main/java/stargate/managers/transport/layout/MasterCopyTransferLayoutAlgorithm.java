 ...
 * @author iychoi
 */
public class MasterCopyTransferLayoutAlgorithm extends AbstractTransferLayoutAlgorithm {
    
    public MasterCopyTransferLayoutAlgorithm(AbstractService service, TransportManager manager, AbstractBigKeyValueStore dataCacheStore, AbstractContactNodeSelectionAlgorithm contactNodeSelectionAlgorithm) {
        if(service == null) {
    ...
    public MasterCopyTransferLayoutAlgorithm(StargateService service, TransportManager manager, AbstractBigKeyValueStore dataCacheStore, AbstractContactNodeSelectionAlgorithm contactNodeSelectionAlgorithm) {
        if(service == null) {
            throw new IllegalArgumentException("service is null");
        }
